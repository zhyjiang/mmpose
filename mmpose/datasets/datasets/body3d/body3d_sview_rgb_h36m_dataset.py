...
@DATASETS.register_module(name='Body3DSViewH36MDataset')
class Body3DSViewH36MDataset(Kpt3dSviewKpt2dDataset):
    ...
    def __init__(self,
        ...
        ann_info = {
            'image_size': np.array(self.data_cfg['image_size']),
    ...
    def prepare_data(self, idx):
        ...
        results = {
            ...
            'target_3d': _joints_3d[target_idx, :, :3],
            'target_visible': _joints_3d[target_idx, :, -1:],
            'image_files': _imgnames,
            'image_file': osp.join(self.img_prefix, _imgnames[target_idx]),
